...
```{r simrel1-plot}
plot(sim_obj, layout = matrix(c(1, 1, 2, 3), 2, 2, byrow = TRUE))
```
...
```{r simrel2_plot}
plot(simrel2_obj, layout = matrix(c(1, 1, 2, 3), 2, 2, byrow = TRUE))
```
...
plot(simrel_m_obj, layout = matrix(c(1, 1, 2, 3), 2, 2, byrow = TRUE))
```
